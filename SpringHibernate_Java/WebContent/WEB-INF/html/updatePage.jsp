	...
	<div class="workarea">
		<div class="table">
			...
			<div class="editarea update">
				<form method="post"
					action="updateAction">
					    <span id="updateid">ID:</span><input type="text" name="id" id="ID3"value="${id }"  readonly> 
						<input type="text" name="name" id="name3" class="insertbox" value="${name }"> 
						<input type="text" name="price" id="price3"  class="insertbox" value="${price }">
					...
					<div class="btn-area" id="update-btnarea">					
						<button id="redo"><a href="selectAll"></a>取消</button>						
						<button id="button3" type="submit">確認修改</button>
					</div>
				</form>
